...
<div class="login-text">
    ...
    <div class="mb-3">
        <label for="Email" class="form-label" style="color:white">Email</label>
        <input type="email" class="form-control" id="exampleFormControlInput1" name="Login_Email" placeholder="user@example.com">
    </div>
    <div class="mb-3">
        <label for="Password" class="form-label" style="color:white">Password</label>
        <input type="password" class="form-control" id="exampleFormControlInput1" name="Login_Password" placeholder="Enter your password">
    </div>
    <button type="submit" class="btn btn-primary" onclick="Login()">Login</button>
    <button type="button" class="btn btn-link" onclick="toggleToRegistrationForm()">Register</button>
</div>
<script>
    ...
    else
    {
        ...
        $.ajax({
                ...
                window.location = "profile.php";
                        ...
                        {
                            alert('Email Id is already taken.Try new one');
                        }
                        else
                        {
